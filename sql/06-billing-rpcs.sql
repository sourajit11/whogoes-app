-- ============================================
-- WhoGoes - Billing RPCs
-- Run this in Supabase SQL Editor AFTER 05-payments.sql
-- ============================================

-- RPC: get_payment_history
-- Returns all payments for the current user, most recent first.
...
-- RPC: get_usage_history
-- Returns credit usage grouped by event, most recent first.
-- Each row = one event the user unlocked contacts from.
