---
title: "HIMSS 2026 Attendee List: Who's Going and How to Reach Them"
description: "Get the HIMSS 2026 attendee list with verified health IT contacts. Buyer personas, attendee profiles, and HIMSS-specific buying signals for B2B sales teams."
date: "2026-03-20"
updatedDate: "2026-06-02"
author: "Sam Kumar"
category: "event-guides"
tags: ["HIMSS 2026 attendee list", "HIMSS 2026", "healthcare IT trade show", "health tech", "attendee intel", "B2B sales", "digital health", "HIMSS attendee data"]
...
faqs:
  ...
  - question: "Who typically attends HIMSS 2026?"
    answer: "Typical HIMSS 2026 attendees include health system CIOs and CISOs, Chief Medical Information Officers (CMIOs), Chief Nursing Information Officers (CNIOs), VPs of Revenue Cycle, clinical informaticists, digital health vendors, payer technology leaders, and government officials from ONC and CMS. Roughly two-thirds work for hospitals, health systems, or payers; the remainder are vendors, consultants, and policy professionals."
  ...
  - question: "How do I get a HIMSS 2026 attendee list?"
    answer: "WhoGoes surfaces verified HIMSS 2026 attendees from public LinkedIn posts, providing names, titles, companies, emails, and proof of attendance. Preview 5 contacts free."
  - question: "Can I buy a HIMSS attendee list?"
    answer: "HIMSS does not sell attendee lists directly. You can build your own using LinkedIn-based tools like WhoGoes that track public posts mentioning HIMSS attendance."
---

> **Quick answer:** A HIMSS 2026 attendee list includes verified names, titles, and emails of the ~30,000 healthcare IT professionals who attended in Las Vegas. WhoGoes surfaces HIMSS attendees from public LinkedIn posts with proof of attendance. Preview 5 contacts free at [/events/himss-2026](/events/himss-2026).
...
That specificity is the opportunity. For B2B sellers in health tech, HIT platforms, cybersecurity for healthcare, revenue cycle solutions, or population health, HIMSS is the single most concentrated moment your buyers share the same space all year. But only if you know who's actually in the room. That's the catch. Know your list.
...
| Exhibitors | 1,000+ |
| Decision-makers or influencers | ~75% |
| C-suite | ~33% |
| Dates | March 9-13, 2026 |
| Venue | Venetian Expo, Las Vegas |

<Figure src="/blog/himss-hlth-vive-2026-attendance.svg" alt="Bar chart comparing 2026 attendance for HIMSS, HLTH, and ViVE healthcare IT conferences" caption="HIMSS dwarfs HLTH and ViVE on attendance, which is why it's the operational health IT buying event. Source: conference organizer figures." />
...
Nearly 75% of HIMSS attendees are decision-makers or influencers. About one-third are C-suite. That's an unusual concentration for a 30,000-person event. Rare density. For sellers, that concentration is the entire reason HIMSS earns a line in the travel budget, because nowhere else do this many health system decision-makers and their internal champions gather under one roof at the same time.
...
<EventCTA slug="himss-2026" name="HIMSS 2026" />

<Figure src="/blog/whogoes-preview-locked.jpg" alt="WhoGoes HIMSS 2026 attendee list with free preview rows unlocked and the rest locked" caption="Preview the first HIMSS 2026 contacts free, then unlock the full verified list." />
...
If you're allocating your health tech event budget across multiple conferences, understanding the actual audience differences matters. They're not interchangeable. Three shows. Three crowds.
...
Healthcare buyers are a specific audience for post-event follow-up. Speed matters here. The executives you're emailing process dozens of vendor messages in the first week after HIMSS, so the note that gets a reply is the one that references a specific session, mandate, or hallway conversation rather than the event in general. A few things that work:
...
You don't need to spend $10,000+ on an [organizer list](/compare/whogoes-vs-event-attendee-lists) or burn hours scrolling LinkedIn manually. There's a faster way.
...
<Figure src="/blog/whogoes-proof-view.jpg" alt="WhoGoes contact with the LinkedIn post shown as proof of HIMSS attendance" caption="Every WhoGoes contact links to the public LinkedIn post proving they attended." />

Preview 5 HIMSS 2026 contacts free on the [HIMSS 2026 event page](/events/himss-2026) before spending anything. If you need more, credits start at $29 for 200 contacts. No subscription, no contract, credits never expire. Unlike purchased lists or generic healthcare databases, every contact comes with LinkedIn proof they were actually at HIMSS, not just a name from a hospital directory.

One balance. Every event. Across 1,200+ events, it's the fastest way to go from "who attended HIMSS?" to a CRM-ready outreach list with evidence of attendance, and if you're also prospecting for HLTH 2026 or ViVE 2027, the same credits carry over so you never have to rebuild your tooling for the next show on the calendar.
...
Keep going. Four picks. These guides go deeper on sourcing verified attendee data, using it inside an SDR outreach motion, planning your event calendar, and the overlapping digital health show that shares much of the HIMSS audience.
...
- [VIVE 2026 Attendee List](/events/vive-2026) - the other major US digital health show that overlaps significantly with HIMSS audience
