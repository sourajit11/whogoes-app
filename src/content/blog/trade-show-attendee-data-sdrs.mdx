...
I've seen this play out dozens of times. A company spends $30K on a booth, sends four people to Vegas, and comes back with 40 [badge scans](/compare/whogoes-vs-scan2lead). Of those, maybe 8 are qualified. That's $3,750 per lead before anyone even picks up the phone.
...
**Reply rate by data source.** Compare reply rates across different attendee data sources: organizer list vs. LinkedIn-verified data vs. general database. In most cases, [LinkedIn-verified data](/blog/how-to-verify-trade-show-attendance) pulls higher reply rates because the outreach references a specific, verifiable action (their LinkedIn post).
