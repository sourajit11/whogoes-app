...
## ICSC Las Vegas 2026: By the Numbers

Numbers first. The baseline scale of the show, from ICSC and industry figures, so you know what you're working with before you build a list.
...
| **Attendees** | 25,000+ |
| **Primary Crowd** | Retail CRE: owners, developers, retailers, brokers, REITs |
| **New for 2026** | ICSC+PROPTECH (Wynn Las Vegas, May 18) |
| **Show Floor Opens** | May 19 |
| **Attendee List Sold?** | No, ICSC prohibits third-party distribution |
| **Domestic Share (2024)** | ~99% U.S.-based |

*Source: [ICSC](https://www.icsc.com/attend-and-learn/events/details/las-vegas-2026) and industry attendance figures*

<Figure
  src="/blog/icsc-las-vegas-2026-cre-events-by-attendance.svg"
  alt="Bar chart comparing attendance at major commercial real estate events, with ICSC Las Vegas at 25,000 ahead of MIPIM and ICSC New York"
  caption="ICSC Las Vegas is the single largest retail real estate gathering on the calendar, ahead of MIPIM and roughly triple the size of ICSC New York. Source: organizer and industry figures, 2025 editions."
/>

That scale is the opportunity and the problem. The right buyers are all here. So is the noise. Everything below is about cutting through it.

---

## Why ICSC Las Vegas Demands a Different Outreach Approach

ICSC isn't like a SaaS conference where buyers attend sessions, collect swag, and go home to evaluate vendors over the next quarter. CRE professionals think in terms of deals, not demos. The speed is different. Way different.
...
<Figure
  ...
  alt="WhoGoes ICSC Las Vegas 2026 attendee list preview showing verified commercial real estate contacts with LinkedIn proof of attendance"
  caption="WhoGoes surfaces verified ICSC attendees from public LinkedIn posts. Filter by segment, title, and company so your pre-event outreach hits owners, brokers, and retailers, not the whole 25,000-person floor."
/>

<EventCTA slug="icsc-las-vegas-2026" name="ICSC Las Vegas 2026" />

---

## Mapping Your ICP to ICSC Las Vegas 2026 Attendee Segments

Before writing a single email, match your offering to the right ICSC attendee segment, because the owner chasing tenants, the broker chasing a faster close, and the REIT analyst chasing cap-rate data are three different conversations that fail the moment you send all of them the same pitch. Each group has different motivations, different meeting formats, and different triggers.
...
CRE professionals get hammered with vendor outreach before ICSC. Hundreds of emails. Most get deleted. Your templates need to feel like they came from someone who understands the industry, not someone who bought a list.
...
Generic subjects get buried. Specificity wins. Open rates live or die here, and a subject line that names a specific market, deal type, or ICSC track will out-pull a vague "meeting at ICSC?" every single time you send it. These are built around what CRE professionals are actually thinking about at ICSC.
...
ICSC runs May 18-20. Timing is everything. CRE dealmaking moves so fast that some attendees have term sheets out and LOIs signed before the show floor even closes on the final afternoon, which means the meeting you wanted was booked weeks before anyone landed in Las Vegas. Every week of outreach counts.
...
These are the patterns that get your emails archived. Avoid them. Most of them come from treating ICSC like a generic trade show instead of the fast-moving, relationship-driven dealmaking event it actually is, where the wrong opening line marks you as an outsider before the prospect reads your second sentence.
...
Every sequence in this playbook needs one thing to work: a list of people who are actually attending ICSC Las Vegas 2026. ICSC doesn't sell [attendee data](/compare/whogoes-vs-event-attendee-lists) and prohibits third-party distribution. No official list exists. So you need a different approach.

WhoGoes surfaces verified ICSC Las Vegas 2026 attendees from public LinkedIn posts. Real attendees. Real proof. You get names, job titles, companies, emails, and the actual LinkedIn post as proof of attendance. That proof matters for CRE outreach, when your email references a prospect's own public post about heading to Las Vegas for ICSC, it separates you from every vendor who's clearly working a purchased list.
...
- [How to Tell If an Event Attendee List Is Fake or Genuine](/blog/fake-vs-genuine-event-attendee-list), red flags to check before you pay for a CRE contact list
