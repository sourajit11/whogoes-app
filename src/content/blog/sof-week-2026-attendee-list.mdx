...
description: "Get the SOF Week 2026 attendee list (also called the SOF Week attendance list) with verified defense contacts. Buyer personas, attendee segments, and procurement signals for B2B sales teams targeting special operations."
date: "2026-04-03"
updatedDate: "2026-06-08"
author: "Sam Kumar"
category: "event-guides"
tags: ["SOF Week 2026 attendee list", "SOF Week 2026", "defense trade show", "special operations conference", "attendee intel", "B2B sales", "defense procurement", "USSOCOM", "SOF Week 2026 exhibitors", "who attends SOF Week"]
...
faqs:
  ...
  - question: "Where can I find the SOF Week 2026 attendance list?"
    answer: "Most databases call it the attendee list, but it's the same thing as a SOF Week 2026 attendance list. WhoGoes builds a verified version from public LinkedIn posts that mention SOF Week. Preview 5 contacts free at /events/sof-week-2026, then unlock more from $29."
  ...
  - question: "Who attends SOF Week 2026?"
    answer: "SOF Week 2026 attendees include active duty military and USSOCOM personnel (free registration), defense industry executives ($640-$800), government civilians (free), allied nation SOF delegations from 60+ countries (free, by invitation), and small business and startup innovators. Over 19,000 attendees in 2025."
  - question: "How many exhibitors are at SOF Week 2026?"
    answer: "SOF Week 2026 features 800+ exhibitors at the Tampa Convention Center, ranging from defense primes like L3Harris and Raytheon to startups in Accelerator Alley showcasing emerging SOF technology."
---
...
A **SOF Week 2026 attendee list** (sometimes searched as the SOF Week attendance list) is a database of verified professionals attending SOF Week in Tampa, Florida from May 18-21, 2026, including names, job titles, companies, and contact details.
...
## SOF Week 2026: By the Numbers

Numbers first. Then context. Here's the baseline data for SOF Week 2026, sourced from official organizer figures, so you have something to reference when building your outreach targeting criteria.
...
| **Military/Government Registration** | Free |
| **Industry Full Conference Pass** | $640-$800 |
| **Organizers** | USSOCOM + Global SOF Foundation |

*Source: [Global SOF Foundation](https://gsof.org/) and [sofweek.org](https://sofweek.org/)*

<Figure
  src="/blog/whogoes-list-preview.jpg"
  alt="WhoGoes SOF Week 2026 attendee list preview showing verified defense contacts with LinkedIn proof"
  caption="WhoGoes surfaces verified SOF Week attendees from public LinkedIn posts. Each contact includes the post as proof of attendance."
/>
...
SOF Week is structured around functional areas and programming tracks. Five distinct areas. Knowing which track your prospect attended tells you more about their buying intent than their badge title — a CNECT attendee is categorically different from someone who spent the day in the SOF Community Corridor, and treating them the same way wastes your outreach.

### CNECT Meetings

This is where procurement conversations actually happen. CNECT connects technology companies with USSOCOM acquisition representatives for structured, one-on-one capability briefings. If a contact attended CNECT sessions, they are actively evaluating solutions. Treat them as mid-funnel leads. That's the signal.

<EventCTA slug="sof-week-2026" name="SOF Week 2026" />
...
Defense procurement doesn't move like SaaS sales. But SOF Week generates specific signals that separate browsers from buyers — and the clearest ones rarely show up on a badge or a LinkedIn title, which is why most vendors miss them entirely and send the same generic follow-up to everyone they scanned.
...
SOF Week is the only major defense event co-hosted by a combatant command. That means the attendee mix includes more operators and end-users than conferences run purely by industry associations. Pick carefully. If your technology serves special operations specifically, tactical communications, ISR platforms, SOF-specific logistics, human performance optimization, SOF Week is your primary event. Nothing else concentrates this audience in one place. AUSA is broader. Sea-Air-Space is maritime. SOF Week is purpose-built.
...
<Figure
  src="/blog/whogoes-proof-view.jpg"
  alt="WhoGoes proof view showing a LinkedIn post from a SOF Week attendee confirming event attendance"
  caption="Every WhoGoes contact includes the public LinkedIn post as proof of attendance, so your outreach references something real rather than a scraped database entry."
/>

## The SOF Week Attendee Profiles Most Vendors Walk Right Past

Everyone targets the USSOCOM Commander's keynote crowd. That's the obvious move. The profiles that actually convert are less visible but closer to procurement authority — and because most vendors overlook them, you'll face less competition in those conversations, which matters a lot in a market where relationship history determines who gets into the evaluation pipeline.
...
Defense audiences don't respond to the same outreach playbook as commercial B2B. A few principles that separate effective SOF Week outreach from generic vendor emails — principles that experienced defense sales teams learn after a couple of wasted quarters sending SaaS-style cadences to people who have procurement cycles measured in years, not weeks.
...
SOF Week organizers don't publish or sell a full [attendee list](/compare/whogoes-vs-event-attendee-lists). No list exists. That's standard for defense events co-hosted by a combatant command. You have to build your own, and the method matters.
...
Read these next. All free. They go deeper on everything covered above, whether you're new to event attendee lists or looking to sharpen how you qualify and sequence defense contacts before and after SOF Week — covering everything from verification methods to how B2B sales teams at defense-adjacent companies structure their event outreach cadences.
