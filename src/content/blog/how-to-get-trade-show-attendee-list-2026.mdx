...
Traditional data brokers and mailing list providers sell event attendee lists compiled from registration data, badge scans, and public records. These are typically one-time purchases or part of a larger data subscription.
