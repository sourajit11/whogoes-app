---
title: "Trade Show Outreach Email Templates: Pre-Event, At-Show & Follow-Up"
description: "Copy-paste pre trade show email templates and trade show follow-up email templates SDRs use to book meetings. 9 examples for pre-event, at-show, and post-event outreach."
date: "2026-03-23"
updatedDate: "2026-04-30"
author: "Sam Kumar"
category: "outreach-tactics"
tags: ["trade show outreach email templates", "trade show follow up email", "pre trade show email template", "trade show follow up email examples", "trade show email examples", "book meetings at trade shows", "exhibitor pre show email template", "post trade show email", "conference outreach templates"]
...
howto:
  name: "How to Run a Trade Show Email Outreach Sequence"
  description: "Six-stage cadence covering pre trade show email templates, at-show outreach, and trade show follow-up email templates that consistently book meetings."
  steps:
    - name: "Identify confirmed attendees 6-8 weeks out"
      text: "Pull a verified attendee list from public LinkedIn posts or the organizer roster. Filter to ICP titles. Skip generic exhibitor lists where attendance is unconfirmed."
    - name: "Send awareness emails 6-4 weeks before the show"
      text: "Open with a soft heads-up that you will both be at the event. Reference one session, keynote, or theme they likely care about. No meeting ask yet."
    - name: "Send specific meeting requests 3-2 weeks out"
      text: "Calendars get locked here. Propose two concrete time windows (e.g. Tuesday 11am or Wednesday 2pm) and a specific 15-minute topic, not a generic demo."
    - name: "Send a short nudge in the final week"
      text: "Reply to your earlier thread with one or two sentences. Keep it low-friction. Most replies come from the nudge, not the original ask."
    - name: "Follow up the same day after meeting at the booth"
      text: "Reference what you actually discussed. Send the resource you promised. Most reps wait 3-5 days; same-day reply doubles your chance of a reply."
    - name: "Run a 3-5 email follow-up sequence over 2-3 weeks post-show"
      text: "Day 1, day 4, day 9, day 16, day 23. Industry data shows 3.5 touches close a trade show lead. Most reps quit after one. Add a final breakup email so silent contacts can opt out cleanly."
---

> **Quick answer:** Trade show outreach emails — pre trade show email templates, at-show notes, and trade show follow-up email templates — book the most meetings when they reference a specific session, attendee post, or theme from the event. Below: 9 copy-paste examples covering pre-event outreach (6-8 weeks out), at-show same-day notes, and post-event follow-up emails, plus the exact timing SDRs use to turn opens into booked meetings.
...
**Related:** [Browse all trade show attendee lists](/events) to find verified attendees for your next event. Popular events include [HIMSS 2026](/events/himss-2026) and [RSAC 2026](/events/rsac-2026).
