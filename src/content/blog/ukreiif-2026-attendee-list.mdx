...
- [Real Estate & Infrastructure Trade Shows 2026](/blog/real-estate-infrastructure-trade-shows-2026) — vertical guide covering UKREiiF, MIPIM, ICSC, and other property events
- [MIPIM 2026 Attendee List](/events/mipim-2026): the Cannes property show that overlaps significantly with UKREiiF's investor and developer audience
- [WhoGoes vs Event Organizer Attendee Lists](/compare/whogoes-vs-event-attendee-lists): what UKREiiF's official list costs and what's actually inside
