...
update shootday_partners_discovery.organizers set
  ...
  is_target              = null,
  reason                 = null,
  organized_count        = null,
  sponsored_count        = null,
  industries             = null,
  next_qualified_event   = null,
  is_next_event_found    = null,
  upcoming_events_detail = null,
  updated_at             = now();

alter table shootday_partners_discovery.organizers
  drop column if exists photo_video_fit;
...
revoke execute on function
  public.spd_set_organizer_qualification(uuid,text,text,text,boolean,text,integer,integer,text,text,boolean,jsonb)
