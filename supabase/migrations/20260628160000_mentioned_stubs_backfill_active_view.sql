-- Active/upcoming-event subset of v_mentioned_stubs_backfill, used to prioritize
-- the outreach-relevant mentioned stubs in the Phase 5b backfill first. Same stub
-- conditions, restricted to events that are live (is_active) or WhoGoes-active and
-- still upcoming. Convergence is identical (enrich_contact sets is_enriched=true).
