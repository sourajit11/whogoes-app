...
drop function if exists public.spd_set_organizer_qualification(
  uuid,text,text,text,text,boolean,text,integer,integer,text,text,boolean,jsonb,boolean,text[]);

drop function if exists public.spd_set_organizer_qualification(
  uuid,text,text,text,boolean,text,integer,integer,text,text,boolean,jsonb);
...
revoke execute on function
  public.spd_set_organizer_qualification(uuid,text,text,text,boolean,text,integer,integer,text,text,boolean,jsonb,boolean,text[])
