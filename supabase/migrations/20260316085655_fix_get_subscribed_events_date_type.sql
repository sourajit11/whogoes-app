-- ============================================
-- Migration: Fix get_subscribed_events return type
-- Bug: event_start_date declared as TIMESTAMPTZ but events.start_date is DATE
-- Fix: Change return type to DATE
-- ============================================
