-- Add per-contact is_speaker (for this event) to the My Events contact rows so the
-- Unlocked Events table can show a speaker indicator (🎤) next to the role badge.
